use crate::img::io::read_byte;
use crate::img::io::read_u16be;
use crate::img::io::read_i16be;
...
impl Data {
    pub fn get(data_type:String,data: &[u8],length: usize) -> Data {
        match data_type  {
            _ => {
