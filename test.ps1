...
foreach ($method in @('deleteLayer', 'moveLayer', 'getLayerImageData', 'setLayerImageData', 'floodFill', 'fillPathSolid', 'strokeStyledPath')) {
...
$url = "http://127.0.0.1:$Port/tests/web-paint-ui.html"
